...
ts = ts.cumsum()
ts.plot()
plt.savefig("./testing/rspandas/test1.png")
df = pd.DataFrame(
...
df.plot()
plt.legend(loc='best')
plt.savefig("./testing/rspandas/test2.png")
...
print_series(84, pd.read_excel("./testing/rspandas/test5.xlsx", "Sheet1", index_col=None, na_values=["NA"]))
